...
if (!empty($_POST)) {
    ...
    $Na = isset($_POST['category_id']) ? $_POST['category_id'] : '';
    $Last_update = isset($_POST['last_update']) ? $_POST['last_update'] :date('Y-m-d H:i:s');
    // Insert new record into the contacts table
    $stmt = $pdo->prepare('INSERT INTO film_category VALUES (?, ?, ?)');
...
<div class="content update">
	<h2>Create Film_Category</h2>
    <form action="create_film_category.php" method="post">
